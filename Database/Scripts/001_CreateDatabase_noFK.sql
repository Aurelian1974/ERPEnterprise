...
-- Same as 001_CreateDatabase.sql but without FK to Persoane (created later)
-- Users table
...
BEGIN
    CREATE TABLE [dbo].[Users] (
        ...
        -- FK to Persoane will be added later via ALTER TABLE
    );
...
PRINT 'Identity base tables (no Persoane FK) created successfully.';