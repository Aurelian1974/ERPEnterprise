-- Force-Recreate-InsertPurchaseInvoice.sql
-- Forțează recrearea procedurii sp_Document_InsertPurchaseInvoice

PRINT '=== Force Recreate sp_Document_InsertPurchaseInvoice ===';
PRINT '';
...
ELSE
BEGIN
    PRINT 'ℹ Procedure did not exist';
END
...
-- Recreate procedure with correct logic
...
PRINT '✓ Procedure sp_Document_InsertPurchaseInvoice recreated successfully';
PRINT '';
